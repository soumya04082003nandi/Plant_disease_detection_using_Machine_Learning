...
def uploadimage():
    if request.method == "POST":
        ...
        # current file
        return render_template('result.ejs',result=True,imagepath = f'/{temp_name}_{image.filename}', prediction = prediction )
...
# //creating for testing purpose only

# @app.route('/test',methods = ['GET'])
# def test():
#     return render_template('result.ejs')
